Oracle JDBC Driver patch release 19.23.0.0 Readme.txt
======================================================

Driver Versions
---------------

These are the driver versions in the 19.23.0.0 release:

  - JDBC Thin Driver 19.23.0.0
    100% Java client-side JDBC driver for use in client applications,
    middle-tier servers and applets.

  - JDBC OCI Driver 19.23.0.0
    Client-side JDBC driver for use on a machine where OCI 19.23.0.0
    is installed.

  - JDBC Thin Server-side Driver 19.23.0.0
    JDBC driver for use in Java program in the database to access
    remote Oracle databases.

  - JDBC Server-side Internal Driver 19.23.0.0
...
In order to use the JDBC Thin Driver 19.23.0.0, please add ojdbc8.jar or
